...
namespace EODHistoricalData.NET.Tests
{
    ...
    public class FundamentalDataAsyncTests
    {
        ...
        public async Task fundamental_stock_returns_data_async()
        {
            ...
            var fundamental = await client.GetFundamentalStockAsync(Consts.Instance.TestSymbol);
        ...
        {
            using var client = new EODHistoricalDataAsyncClient(Consts.Instance.ApiToken, true);
            var fundamental = await client.GetFundamentalETFAsync(Consts.Instance.TestETF);
            Assert.IsNotNull(fundamental);
        }
        ...
        {
            using var client = new EODHistoricalDataAsyncClient(Consts.Instance.ApiToken, true);
            var fundamental = await client.GetFundamentalFundAsync(Consts.Instance.TestFund);
            Assert.IsNotNull(fundamental);
        }
        ...
        {
            using var client = new EODHistoricalDataAsyncClient(Consts.Instance.ApiToken, true);
            var index = await client.GetIndexCompositionAsync(Consts.Instance.TestIndex);
        ...
        {
            using var client = new EODHistoricalDataAsyncClient(Consts.Instance.ApiToken, true);
            var instruments = await client.GetExchangeInstrumentsAsync(Consts.Instance.Exchange);
